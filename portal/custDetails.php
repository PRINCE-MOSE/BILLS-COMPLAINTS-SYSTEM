<h4 class="btn btn-primary">Customer Details - Admin View</h4>
<p>To Add a New Customer/Client  <a href="view.php?mod=admin&view=addCust" class="btn btn-success">Add New </a> </p>
<form action="" method="post"  name="frmListUser" id="frmListUser">
  <table width="100%" border="2" align="center"style="border-radius:10px;"  cellpadding="2" cellspacing="1" class="text">
    <tr align="center" id="listTableHeader">
      <td width="453">Customer Name </td>
      <td width="">Email</td>
      <td width="265">Mobile No. </td>
      <td width="207">Actions</td>
    </tr>
    <?php
